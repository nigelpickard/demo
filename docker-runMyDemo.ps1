...
# powershell -executionpolicy remotesigned -File %MYDEMO_PATH%\myDemo\docker-runMyDemo.ps1 [container name part] [this mapped port number] [database name] [db mapped port] [stop]
#
# e.g.
# powershell -executionpolicy remotesigned -File %MYDEMO_PATH%\myDemo\docker-runMyDemo.ps1 myDemo 8080 myDemoDb 3306 stop
#
#
#############################################
